...
public class EntityHarpoon extends Entity
{
	private int xTile = -1;
	private int yTile = -1;
	private int zTile = -1;
	...
	public ItemHarpoon itemHarpoon = (ItemHarpoon)WhaleMod.harpoonW;

	public EntityHarpoon(World par1World)
	{
		super(par1World);
		this.setSize(0.5F, 0.5F);
	}

	public EntityHarpoon(World par1World, double par2, double par4, double par6)
	{
		super(par1World);
		this.setSize(0.5F, 0.5F);
	...
	public EntityHarpoon(World par1World, EntityLiving par2EntityLiving, EntityLiving par3EntityLiving, float par4, float par5)
	{
		super(par1World);
	...
	public EntityHarpoon(World par1World, EntityLiving par2EntityLiving, float par3)
	{
		super(par1World);
		this.shootingEntity = par2EntityLiving;
	 ...
	 public void setArrowHeading(double par1, double par3, double par5, float par7, float par8)
	{
	 ...
	 public void onUpdate()
	 {
		 ...
		 if (var16 > 0)
		 {
			 ...
			 if (var2 != null && var2.isVecInside(Vec3.field_82592_a.getVecFromPool(this.posX, this.posY, this.posZ)))
			 {
				 this.inGround = true;
			 }
		 }
		 ...
		 {
			 ++this.ticksInAir;
			 Vec3 var17 = Vec3.field_82592_a.getVecFromPool(this.posX, this.posY, this.posZ);
			 Vec3 var3 = Vec3.field_82592_a.getVecFromPool(this.posX + this.motionX, this.posY + this.motionY, this.posZ + this.motionZ);
			 MovingObjectPosition var4 = this.worldObj.rayTraceBlocks_do_do(var17, var3, false, true);
			 var17 = Vec3.field_82592_a.getVecFromPool(this.posX, this.posY, this.posZ);
			 var3 = Vec3.field_82592_a.getVecFromPool(this.posX + this.motionX, this.posY + this.motionY, this.posZ + this.motionZ);

			 if (var4 != null)
			 {
				 var3 = Vec3.field_82592_a.getVecFromPool(var4.hitVec.xCoord, var4.hitVec.yCoord, var4.hitVec.zCoord);
			 }
	 ...
	 public void onCollideWithPlayer(EntityPlayer par1EntityPlayer)
	 {
		 if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
		 {
			 ...
			 if (this.canBePickedUp == 1 && !par1EntityPlayer.inventory.addItemStackToInventory(new ItemStack(this.itemHarpoon, 1)))
			 {
				 var2 = false;
			 }
